...
\lstinputlisting[firstline=5, lastline=25, float=!ht, caption={Sparse Table. Complementary to BIT}]{../datastruct/sparse_table.cpp}
...
\lstinputlisting[firstline=60, lastline=110, float=!ht, caption={Combinations.}]{../math/comb.cpp}
...
\lstinputlisting[firstline=5, lastline=31, float=!ht, caption={Suffix Array.}]{../string/sa.cpp}

\lstinputlisting[firstline=5, lastline=26, float=!ht, caption={Trie.}]{../string/trie.cpp}
