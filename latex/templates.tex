...
\lstinputlisting[firstline=1, lastline=11, float=!ht, language=Python, caption={Runner Script.}]{../runner.py}

% DATA STRUCTURE
\lstinputlisting[firstline=5, lastline=18, float=!ht, caption={1-indexed BIT.}]{../datastruct/bit_simple.cpp}
...
\lstinputlisting[firstline=5, lastline=21, float=!ht, caption={DSU.}]{../datastruct/dsu_simple.cpp}

% GRAPH
\lstinputlisting[firstline=7, lastline=42, float=!ht, caption={Dijkstra Shortest Path.}]{../graph/dijkstra.cpp}


\lstinputlisting[firstline=6, lastline=50, float=!ht, caption={KM Optimal Pairing.}]{../graph/km.cpp} % refactor
...
\lstinputlisting[firstline=16, lastline=25, float=!ht, caption={Recurrsion Acceleration.}]{../math/rec_acc.cpp}
...
\lstinputlisting[firstline=5, lastline=59, float=!ht, caption={AC Automaton to get every \#occurence.}]{../string/acaa.cpp}
