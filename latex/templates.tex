...
\lstinputlisting[firstline=41, lastline=83, float=!ht, caption={Segment Tree.}]{../graph/heavy_path.cpp}


\lstinputlisting[firstline=7, lastline=54, float=!ht, caption={Lazy-tag Segment Tree.}]{../datastruct/segment_tree.cpp}


\lstinputlisting[firstline=41, lastline=91, float=!ht, caption={Segment Tree supporting segment copying.}]{../datastruct/segment_tree_mem.cpp}


\lstinputlisting[firstline=9, lastline=50, float=!ht, caption={Segment Tree for segments.}]{../datastruct/segment_tree_lc.cpp}


\lstinputlisting[firstline=32, lastline=47, float=!ht, caption={DSU.}]{../datastruct/dsu.cpp}
...
% GRAPH
\lstinputlisting[firstline=5, lastline=52, float=!ht, caption={Tarjan Cut Vertex.}]{../graph/cut_vertex.cpp}
\addcontentsline{toc}{section}{Graph}


\lstinputlisting[firstline=5, lastline=43, float=!ht, caption={Tarjan BCC.}]{../graph/bcc.cpp}


\lstinputlisting[firstline=7, lastline=25, float=!ht, caption={Kosaraju SCC.}]{../graph/scc.cpp}


\lstinputlisting[firstline=118, lastline=147, float=!ht, caption={Heavy-light Decomposition.}]{../graph/heavy_path.cpp}
...
\lstinputlisting[firstline=43, lastline=53, float=!ht, caption={Walsh-Hadamard Transform.}]{../math/hadamard.cpp}

\lstinputlisting[firstline=55, lastline=75, float=!ht, caption={Sum of Geometric Sequence.}]{../math/hadamard.cpp}
...
\lstinputlisting[firstline=7, lastline=19, float=!ht, caption={Linear Sieve.}]{../math/sieve.cpp}

\lstinputlisting[firstline=5, lastline=28, float=!ht, caption={Bezout's Lemma.}]{../math/bezout_lemma.cpp}


\lstinputlisting[firstline=14, lastline=44, float=!ht, caption={Millar Rabin Prime test.}]{../math/pollard_rho.cpp}

\lstinputlisting[firstline=46, lastline=62, float=!ht, caption={Pollard Rho.}]{../math/pollard_rho.cpp}
...
\lstinputlisting[firstline=17, lastline=22, float=!ht, caption={Matrix Definition.}]{../math/matrix.cpp}


\lstinputlisting[firstline=74, lastline=124, float=!ht, caption={Matrix Inversion.}]{../math/matrix.cpp}


\lstinputlisting[firstline=6, lastline=46, float=!ht, caption={Linear Basis.}]{../math/linear_basis.cpp}


% MISC
\lstinputlisting[firstline=4, lastline=55, float=!ht, caption={Polygon.}]{../misc/polygon.cpp}
...
\lstinputlisting[firstline=5, lastline=48, float=!ht, caption={AC Automaton to get total frequency.}]{../string/aca.cpp}
...
\lstinputlisting[firstline=75, lastline=104, float=!ht, caption={Suffix Automaton. Compression of Substrs.}]{../string/sam.cpp}
